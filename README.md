...
| --- | --- |
| `codex-free` | `gpt-5.5`, `gpt-5.6-terra`, `gpt-5.6-luna`, `codex-auto-review`, `gpt-reserve` |
| `codex-team` | `gpt-5.5`, `gpt-6-astra`, `gpt-5.6-sol`, `gpt-5.6-terra`, `gpt-5.6-luna`, `codex-auto-review`, `gpt-reserve` |
| `codex-plus` | `gpt-5.3-codex-spark`, `gpt-5.5`, `gpt-6-astra`, `gpt-5.6-sol`, `gpt-5.6-terra`, `gpt-5.6-luna`, `codex-auto-review`, `gpt-reserve` |
| `codex-pro` | `gpt-5.3-codex-spark`, `gpt-5.5`, `gpt-6-astra`, `gpt-5.6-sol`, `gpt-5.6-terra`, `gpt-5.6-luna`, `codex-auto-review`, `gpt-reserve` |

`gpt-reserve` also carries `supports_search_tool: true` in the client template and is
catalogued in all four Codex sections. No model currently has an evidence-backed
